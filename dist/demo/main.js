...
module.exports = "p {\n    font-family: Lato;\n}\n\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbInNyYy9hcHAvYXBwLmNvbXBvbmVudC5jc3MiXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IkFBQUE7SUFDSSxpQkFBaUI7QUFDckIiLCJmaWxlIjoic3JjL2FwcC9hcHAuY29tcG9uZW50LmNzcyIsInNvdXJjZXNDb250ZW50IjpbInAge1xuICAgIGZvbnQtZmFtaWx5OiBMYXRvO1xufVxuIl19 */"
...
module.exports = "<hello name=\"{{ name }}\"></hello>\n<div *ngIf=\"employeesAvailable()\" style=\"margin: 20px\" class=\"container container-fluid\">\n    <div>\n        <table class=\"table table-responsive\">\n            <thead>\n                <tr>\n                    <td>Id</td>\n                    <td>First Name</td>\n                    <td>Last Name</td>\n                </tr>\n            </thead>\n            <tbody  *ngFor=\"let employee of employees\">\n                <tr>\n                    <td>{{employee.id}}</td>\n                    <td>{{employee.firstName}}</td>\n                    <td>{{employee.lastName}}</td>\n                </tr>\n            </tbody>\n        </table>\n    </div>\n    <input type=\"button\" (click)=\"createEmployee()\" value=\"Create New\" class=\"btn btn-primary\">\n</div>\n"
...
/* harmony import */ var _model_employee__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/employee */ "./src/app/model/employee.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getEmployees = function () {
        var _this = this;
        var url = _app_constants__WEBPACK_IMPORTED_MODULE_2__["API_URL"] + 'employees';
        this.employeeService.getEmployees(url).subscribe(function (data) {
            _this.employees = data;
        }, function (error1) {
            console.log('Error');
        });
    };
    AppComponent.prototype.employeesAvailable = function () {
        return this.employees != undefined;
    };
    AppComponent.prototype.createEmployee = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, employee, createdEmployee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = _app_constants__WEBPACK_IMPORTED_MODULE_2__["API_URL"] + 'employees';
                        employee = new _model_employee__WEBPACK_IMPORTED_MODULE_3__["Employee"]();
                        employee.id = Math.floor(Math.random() * 10000);
                        employee.firstName = "John";
                        employee.lastName = "McCain" + employee.id;
                        return [4 /*yield*/, this.employeeService.createEmployee(url, employee)];
                    case 1:
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_service_employee_service__WEBPACK_IMPORTED_MODULE_1__["EmployeeService"]])
    ], AppComponent);
    return AppComponent;
}());
...
var EmployeeService = /** @class */ (function () {
    ...
    EmployeeService.prototype.getEmployees = function (url) {
        return this.httpClient.get(url);
    };
    EmployeeService.prototype.createEmployee = function (url, employee) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.httpClient.post(url, employee).toPromise()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    EmployeeService.prototype.getEmployeeById = function (url) {
        return this.httpClient.get(url);
    };
...
module.exports = __webpack_require__(/*! /Users/pjadda/Downloads/angular-async-await/src/main.ts */"./src/main.ts");
